  ...
  return (
    <div
      ...
      onMouseEnter={e => {
        ...
        ;(e.currentTarget as HTMLDivElement).style.boxShadow = '0 20px 48px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.15)'
      }}
      onMouseLeave={e => {
      ...
      <div className="relative h-44 md:h-52 img-zoom">
        {coverUrl ? (
          ...
          <div className="w-full h-full flex items-center justify-center" style={{ background: 'rgba(255,255,255,0.04)' }}>
            <svg className="w-12 h-12" style={{ color: 'rgba(255,255,255,0.2)' }} fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
        ...
        <div className="absolute top-3 left-3">
          <span
            ...
            style={{
              background: isLocation ? 'rgba(75,107,255,0.85)' : 'rgba(255,107,53,0.85)',
        ...
        >
          <svg viewBox="0 0 24 24" fill={isFav ? '#FF6B35' : 'none'} stroke={isFav ? '#FF6B35' : 'rgba(255,255,255,0.7)'} strokeWidth={2} className="w-4 h-4 transition-colors duration-200">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-16 pointer-events-none"
          style={{ background: 'linear-gradient(to top, rgba(7,7,26,0.7) 0%, transparent 100%)' }} />
      </div>

      {/* Infos */}
      <div className="p-3.5">
        <p className="text-base md:text-lg font-bold leading-tight" style={{ color: '#EEEEF8' }}>
        ...
        <p className="text-sm font-medium mt-0.5" style={{ color: 'rgba(255,255,255,0.7)' }}>{label}</p>
        <div className="flex items-center gap-1 mt-1.5">
          <svg className="w-3.5 h-3.5 flex-shrink-0" style={{ color: 'rgba(255,255,255,0.35)' }} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        ...
        {bien.frais_visite && Number(bien.frais_visite) > 0 && (
          <p className="hidden md:block text-xs mt-2 pt-2" style={{ color: 'rgba(255,255,255,0.35)', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
