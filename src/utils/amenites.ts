// Miroir des labels calculés côté mobile (lib/models/bien.dart → classe Amenites)
// pour afficher les mêmes intitulés lisibles dans le back-office.
...
/** Section "Informations logement" — même regroupement que bien_detail_screen.dart */
...
/** Équipements actifs (espaces / atouts) */
